...
def different_A_initial_interpolation_extrapolation_longtime(result_filename, initial_filename, network, init_random=True):
    logging.info("============================================")
    ...
    # print(true_y)
    # print(results_initial['true_y'][0].to(device))
    # # 即使种子设置的也一样，读取出来的和当前生成的有些微差别，用的是新生成的。
    # print(true_y.equal(results_initial['true_y'][0].to(device)))
    # sys.exit()
...
if __name__ == '__main__':
    ...
    result_filename = "results/biochemical/community/result_ndcn_community_1217-234123_D0.pth"
    for network in network_list:
        ...
        for item in file_name_list:
            different_A_initial_interpolation_extrapolation_longtime(result_filename, item, network, True)
