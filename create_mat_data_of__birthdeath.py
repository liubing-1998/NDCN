...
def create_mat_data_figure_birthdeath_result(filename, init_random=True, T=60, time_tick=1200):
    logging.info("============================================")
    pic_path = ''.join(filename.split('\\')[-1]).split('.')[0] + "_mat_" + str(T) + "_" + str(time_tick) + ".mat"
    logging.info(pic_path)
    save_mat_path = os.path.join('create_mat_data/birthdeath', pic_path)
...
if __name__ == '__main__':
    if (not os.path.exists(r'.\create_mat_data\birthdeath')):
        makedirs(r'.\create_mat_data\birthdeath')
    ...
    log_filename = r'create_mat_data/birthdeath/create_mat_data_of_birthdeath.txt'
    ...
    for filepath in file_name_list:
        ...
        create_mat_data_figure_birthdeath_result(filepath, init_random=True, T=60, time_tick=1200)
